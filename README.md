...
| **D — Glossary** | [`APPENDIX_D.md`](./APPENDIX_D.md) — every coding, AI/ML, and acronym term used across the book, alphabetized and defined for a reader new to the words, not just the tools. |
