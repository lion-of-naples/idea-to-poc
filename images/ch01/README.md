...
| --- | --- | --- | --- |
| `cursor-anatomy.png` | Step 3.2, "Get your bearings" | Labeled diagram of the Cursor window: **Navigation Sidebar** (left rail), **Version Control Details** and **Mode/Model Selector** (Composer 2.5 Fast), the **Prompting Area (Agent Default)**, and **Access to editors** (Browser / Terminal / File). | ✅ captured (labeled) |
